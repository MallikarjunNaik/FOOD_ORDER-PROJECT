...
// handle redirection with useEffect
  ...
  const submitHandler = (e) => {
    ...
    const formData = new FormData();  // {name: prasiddhi, email: pr@gmail.com}
    formData.set("name", name); //name: Rahul, email: vlkghdkf;
  ...
  const onChange = (e) => {
    ...
    if(e.target.name === "avatar"){
      ...
      reader.onload = () => {
        if(reader.readyState === 2){ //indicate the reading is done
